...
#                  v1_clients GET      /v1/clients(.:format)                  api/v1/clients#index {:subdomain=>"api"}
#                             POST     /v1/clients(.:format)                  api/v1/clients#create {:subdomain=>"api"}
#                   v1_client GET      /v1/clients/:id(.:format)              api/v1/clients#show {:subdomain=>"api"}
#                             PATCH    /v1/clients/:id(.:format)              api/v1/clients#update {:subdomain=>"api"}
#                             PUT      /v1/clients/:id(.:format)              api/v1/clients#update {:subdomain=>"api"}
#                             DELETE   /v1/clients/:id(.:format)              api/v1/clients#destroy {:subdomain=>"api"}
